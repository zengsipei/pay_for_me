...
abstract class WxPayConfigInterface
{
     ...
     * @var unknown_type
     */
    abstract public function GetProxy(&$proxyHost, &$proxyPort);
     ...
     * @var int
     */
    abstract public function GetReportLevenl();
     ...
     * @var path
     */
    abstract public function GetSSLCertPath(&$sslCertPath, &$sslKeyPath);
}
